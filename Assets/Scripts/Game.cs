...
public class Game : MonoBehaviour
{
    ...
    public void Winner(string playerWinner)
    {
        ...
        TextMeshProUGUI textComp = GameObject.FindGameObjectWithTag("WinnerText").GetComponent<TextMeshProUGUI>();
        textComp.enabled = true;
        textComp.text = playerWinner + " is the Winner!";

        TextMeshProUGUI textComp2 = GameObject.FindGameObjectWithTag("RestartText").GetComponent<TextMeshProUGUI>();
        textComp2.enabled = true;
        textComp2.text = "Tap to\nRestart";


        //GameObject winnerTextObj = GameObject.FindGameObjectWithTag("WinnerText");
        //winnerTextObj.SetActive(true);
        //winnerTextObj.GetComponent<Text>().text = playerWinner + "is the Winner!";
